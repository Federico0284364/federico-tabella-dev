...
export default function ProjectContainer({ project }: Props) {
	return (
		<motion.a
			...
			className="backdrop-blur-lg bg-light/50 border-fg/20 hover:bg-light transition p-4 md:p-6 rounded-2xl grid grid-cols-1 md:grid-cols-2 items-center gap-x-8 shadow-xl hover:scale-103 hover:shadow-primary/80"
		>
			<Image
