		...
		description: 
			{
				...
				list: ['Manage client-side authentication using Google OAuth', 'Create ad admin panel to view and filter users on a table based on their data', 'Connect admin and auth functions to the server via API calls']
			},
